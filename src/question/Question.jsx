...
<Typography className="text-danger text-center" variant="h2" data-aos="fade-left">
Frequently Asked Questions
</Typography>


<div  data-aos="flip-down" class="accordion accordion-flush" id="accordionFlushExample">
...
You can watch as much as you want, whenever you want without a single commercial – all for one low monthly price. There's always something new to discover and new TV shows and movies are added every week!</div>
  ...
  <div class="accordion-item"   data-aos="zoom-out">
    ...
    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from USD3.99 to USD11.99 a month. No extra costs, no contracts.</div>
    </div>
  </div>
  <div class="accordion-item"  data-aos="zoom-left">
...
You can also download your favorite shows with the iOS, Android, or Windows 10 app. Use downloads to watch while you're on the go and without an internet connection. Take Netflix with you anywhere.</div>
  ...
  <div class="accordion-item"   data-aos="fade-up-bottom">
  ...
  <div class="accordion-item" data-aos="fade-down-bottom">
  ...
  <div class="accordion-item" data-aos="fade-up-right">
...
<h4 className="text-success"  data-aos="fade-up-down">Ready to watch? Enter your email to create or restart your membership.</h4>

<form action="#" data-aos="fade-up-right">
  <input type="text" className='fs-1' placeholder="email ...."/>
<button className='text-light btn-info' data-aos="fade-left-down">get started</button>
</form>
